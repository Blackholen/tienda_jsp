                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
            					...
            					lista.addAll(datos.proveedor(nombre));
            					
            					for( int x=0;x<lista.size();x++ ) 
            					{
            						%>
            						<form action="EditarProveedor2.jsp">
            							<input type="hidden" id="nombre" name="nombre" required value="<%=lista.get(x).getNombre() %>"/>
            							<label>Nombre del proveedor: </label>
            							<input type="text" id="name" name="name" pattern="[a-zA-ZñÑ\s]{2,50}" required value="<%=lista.get(x).getNombre() %>"/><br>
            							<label>Teléfono: </label>
            							<input type="number" id="telefono" name="telefono" pattern="^[9|8|7|6]\d{8}$" required value="<%=lista.get(x).getTelefono() %>"/><br>
