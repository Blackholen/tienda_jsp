...
<%@ page import="paquete.BaseDatos" %><%@ page import="paquete.Category" %><%@ page import="java.util.*" %>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="AgregarCategoria.jsp">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
            					...
            					lista.addAll(datos.category());
            					for( int x=0;x<lista.size();x++ ) 
            					{
            						%>
            						<tr>
                                        <td><%=lista.get(x).getName() %></td>
                                        <td><form action="EditarCategoria.jsp"><input type="hidden" id="ids" name="ids" value="<%=lista.get(x).getId() %>"/><input type="submit" value="Editar"/></form></td>
                                    </tr>
            						<%
            					}
                                %>
