...
<%@ page import="paquete.BaseDatos" %><%@ page import="paquete.Productos" %><%@ page import="java.util.*" %>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <table class="table table-hover">
            					...
            					for( int x=0;x<lista.size();x++ ) 
            					{
            						...
            						<tr>
                                        ...
                                        <td><form><input type="hidden" id="ids" name="ids" value="<%=lista.get(x).getId() %>"/><input type="submit" value="Editar"/></form></td>
                                        <td><form><input type="hidden" id="ids" name="ids" value="<%=lista.get(x).getId() %>"/><input type="submit" value="Eliminar"/></form></td>
                                    </tr>
            						<%
            					}
                                %>
