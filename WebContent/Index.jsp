...
<div class="container">
  ...
  for(int x=0;x<lista.size();) 
	{
	    String name = lista.get( x );
	    String imagen = lista.get( x + 1 );
	    x = x + 2;
	    %>
	    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
	    	<div class="thumbnail"> <img src="img/<%=imagen%>" alt="Thumbnail Image 1" class="img-responsive">
	    		<div class="caption">
          			<h3><%=name %></h3>
